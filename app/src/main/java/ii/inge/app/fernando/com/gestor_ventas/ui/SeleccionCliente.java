    ...
    public class TareaPruebaDatos extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                // Inserción Clientes
                datos.insertarCliente(new Cliente(null, "Veronica", "Gonsalez", "4552000"));
                datos.insertarCliente(new Cliente(null, "Carlos", "Villagran", "4440000"));
                datos.insertarCliente(new Cliente(null, "Juan", "Perez", "3565000"));
