...
public class hacerPedido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText)findViewById(R.id.ingresarCantidad);
    ...
    public void calcularTotal(View vista){
        ...
        String cantidadIngresada = editText.getText().toString();

        if(cantidadIngresada.equals("")){
    ...
    public void registrar(View vista){
        //obtenemos el String de la cantidad ingresada
        String cantidadIngresada = editText.getText().toString();
        ...
        //obtenemos el int de la cantidad ingresada
        cantidad = Integer.parseInt(editText.getText().toString());
